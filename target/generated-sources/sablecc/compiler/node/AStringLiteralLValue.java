...
public final class AStringLiteralLValue extends PLValue
{
    private TConstString _constString_;

    public AStringLiteralLValue()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AStringLiteralLValue(
            cloneNode(this._constString_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAStringLiteralLValue(this);
    }
