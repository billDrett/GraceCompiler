...
public final class AGreaterEqualRelationOper extends PRelationOper
{
    private TGreaterEqual _greaterEqual_;

    public AGreaterEqualRelationOper()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AGreaterEqualRelationOper(
            cloneNode(this._greaterEqual_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseAGreaterEqualRelationOper(this);
    }
