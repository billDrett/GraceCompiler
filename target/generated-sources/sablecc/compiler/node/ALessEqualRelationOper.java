...
public final class ALessEqualRelationOper extends PRelationOper
{
    private TLessEqual _lessEqual_;

    public ALessEqualRelationOper()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessEqualRelationOper(
            cloneNode(this._lessEqual_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseALessEqualRelationOper(this);
    }
