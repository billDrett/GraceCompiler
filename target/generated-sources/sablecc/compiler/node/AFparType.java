...
public final class AFparType extends PFparType
{
    ...
    public PEmptyBr getEmptyBr()
    {
        return this._emptyBr_;
    }

    public void setEmptyBr(PEmptyBr node)
    {
        if(this._emptyBr_ != null)
        {
            this._emptyBr_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._emptyBr_ == oldChild)
        {
            setEmptyBr((PEmptyBr) newChild);
            return;
        }
